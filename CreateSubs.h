...
int CreateSubs(Eqn_list_node *L, const struct polynomial *F, int nVars, int Mdv, const std::vector<std::vector<Basis> > &all_Substitutions, const int *Deg_var_types);
